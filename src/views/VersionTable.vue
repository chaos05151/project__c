<template>
    <div>
        ...
        <div class="container">
            ...
            游戏选择: <el-select style="width:13%" v-model="product_name_selected" placeholder="游戏选择" class="m-2">
                <el-option key="bbk" label="成语" value="0"></el-option>
                <el-option key="wz" label="王者" value="1"></el-option>
                <el-option key="ms" label="魔兽" value="2"></el-option>
            </el-select>&nbsp;
                渠道选择: <el-select style="width:13%" v-model="channel_name_selected" placeholder="渠道选择" class="m-2">
                <el-option key="bbk" label="步步高" value="0"></el-option>
                <el-option key="vivo" label="小天才" value="1"></el-option>
                <el-option key="小米" label="imoo" value="2"></el-option>
            </el-select>&nbsp;
            <el-button type="primary" @click="handleAdd">新增版本
                        </el-button>
            </div>
        ...
        <!-- 编辑弹出框 -->
        <el-dialog title="新增版本" v-model="editVisible" width="60%">
            <el-form label-width="110px">
                <el-form-item label="游戏选择">
                    <el-select style="width:18%" v-model="form.add_product_name_selected" placeholder="游戏选择" class="m-2">
                <el-option key="bbk" label="成语" value="0"></el-option>
                <el-option key="wz" label="王者" value="1"></el-option>
                <el-option key="ms" label="魔兽" value="2"></el-option>
            </el-select>
                ...
                <el-form-item label="渠道选择">
                    <el-select style="width:18%" v-model="form.add_channel_name_selected" placeholder="游戏选择" class="m-2">
                <el-option key="bbk" label="步步高" value="0"></el-option>
                <el-option key="vivo" label="小天才" value="1"></el-option>
                <el-option key="小米" label="imoo" value="2"></el-option>
            </el-select>
                ...
                <el-form-item label="后台版本">
                    <el-input style="width: 160px"  v-model="form.versions_backend"></el-input>
                </el-form-item>
                <el-form-item label="前端版本">
                    <el-input style="width: 160px"  v-model="form.versions_frontend"></el-input>
                </el-form-item>
                          <el-form-item label="预期上线时间" prop="appoint_time">
            <el-date-picker
